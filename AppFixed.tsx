...
import { StoreProvider, useStore } from './context/StoreContextNew';
...
import Accounting from './components/Accounting'; // تم تصحيح الخطأ الإملائي
...
const IntroScreen = ({ onStart }: { onStart: () => void }) => (
  <motion.div initial={{ opacity: 1 }} exit={{ opacity: 0, scale: 1.1, filter: "blur(20px)" }} className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center text-white">
    ...
    <p className="text-slate-400 mb-8 z-10">تم التطوير بواسطة: محمد سعيد</p>
    <p className="text-slate-500 mb-8 z-10 text-sm">whatsapp: 01228252096 | email: trabelshooterss@gmail.com</p>
