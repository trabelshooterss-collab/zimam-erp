...
import { ArrowRight, Smartphone, Monitor, Globe, Power } from 'lucide-react';
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl w-full px-6 text-center">
        ...
        <div className="flex items-center gap-8 text-slate-500">
          <div className="flex flex-col items-center gap-2 hover:text-green-500 transition-colors cursor-pointer">
            <Smartphone size={32} />
            <span className="text-xs font-mono">Android</span>
          </div>
          <div className="flex flex-col items-center gap-2 hover:text-blue-500 transition-colors cursor-pointer">
            <Monitor size={32} />
            <span className="text-xs font-mono">Web / PWA</span>
          </div>
          <div className="flex flex-col items-center gap-2 hover:text-white transition-colors cursor-pointer">
            <Smartphone size={32} />
            <span className="text-xs font-mono">iOS</span>
          </div>
        </div>
